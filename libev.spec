...
Requires: libev-man = %{version}-%{release}
...
%package man
Summary: man components for the libev package.
Group: Default

%description man
man components for the libev package.


%package staticdev
Summary: staticdev components for the libev package.
Group: Default
Requires: libev-dev = %{version}-%{release}

%description staticdev
staticdev components for the libev package.
